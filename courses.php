                    ...
                    <div class="course_nav">
                        <nav>
                            <ul class="nav" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                  <!-- <a class="nav-link" id="contact-tab" data-toggle="tab" href="course_details.php" role="tab" 

                                        aria-controls="contact" aria-selected="false"> --><a href="course_details.php">UI/UX</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            ...
                                            <div class="courses_info">
                                                <span>Adobe XD</span>
                                                <h3><a href="course_details.php">UI/UX design with Adobe XD with Anderson</a></h3>
                                                <div class="star_prise d-flex justify-content-between">
                                                    <div class="star">
                                                        <i class="flaticon-mark-as-favorite-star"></i>
                                                        <span>(4.5)</span>
