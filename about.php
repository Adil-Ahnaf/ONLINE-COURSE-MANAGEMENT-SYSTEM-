            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="single_team">
                        <div class="thumb">
                            <img src="img/team/suman-ahmmed-director-CDIP-UIU.jpg" alt="">
                        ...
                        <div class="master_name text-center">
                            ...
                            <h3>Suman Ahmmed</h3>
                            <p>Director- CDIP, Asst. Professor, CSE, UIU</p>
                        </div>
                    </div>
                </div>
                 <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="single_team">
                        <div class="thumb">
                            <img src="img/team/Professor-Dr.-Chowdhury-Mofizur-Rahman.jpg" alt="">
                            <div class="social_link">
                                <a href="#"><i class="fa fa-envelope"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
                                <a href="#"><i class="fa fa-linkedin"></i></a>
                        ...
                        <div class="master_name text-center">
                            <h3>Professor Dr. Chowdhury Mofizur Rahman</h3>
                            <p>Chief Advisor - CDIP, Vice-Chancellor, UIU</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="single_team">
                        ...
                        <div class="master_name text-center">
                            <h3>Dr. Salekul Islam</h3>
                            <p>Advisor - CDIP, Professor & Head of the Dept. of CSE, UIU</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="single_team">
                        <div class="thumb">
                            <img src="img/team/s.m-jabid-hasan.jpg" alt="">
                            <div class="social_link">
                                <a href="#"><i class="fa fa-envelope"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
                                <a href="#"><i class="fa fa-linkedin"></i></a>
                        ...
                        <div class="master_name text-center">
                            <h3>S.M. Jabid Hasan</h3>
                            <p>Coordinator CDIP, Sr. Web Developer at United International University.</p>
                        </div>
                    </div>
                </div> 
            </div>
